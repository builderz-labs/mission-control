# Graph Report - mission-control  (2026-09-22)

## Corpus Check
- 1349 files · ~1,014,842 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 17 file(s) not represented in the graph (top: (none) 11, .css 2, .example 1)

## Summary
- 7545 nodes · 20411 edges · 330 communities (296 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 204 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fbaac369`
...
## Communities (330 total, 34 thin omitted)

### Community 0 - "vitest"
Cohesion: 0.04
Nodes (33): ref_node_fs, ref_node_os, ref_node_path, vitest, dbRowsByName, partRowsByMessageId, agentInboxDir(), writeAgentInbox() (+25 more)

### Community 1 - "widget-primitives.tsx"
Cohesion: 0.09
Nodes (34): EngineLogoSet(), DashboardGitHubStats, DashboardSystemStats, ActivityIconMini(), AgentIcon(), ClaudeStats, CostIcon(), DashboardData (+26 more)
...
### Community 4 - "getDatabase"
Cohesion: 0.05
Nodes (83): ref_crypto, DELETE(), POST(), GET(), safeParseJson(), ensureUniqueUsername(), GET(), makeUsernameFromEmail() (+75 more)

### Community 5 - "chat-icons.tsx"
Cohesion: 0.10
Nodes (24): IconArtifacts(), IconChevron(), IconClock(), IconCustomize(), IconDispatch(), IconGrip(), IconPin(), IconPlus() (+16 more)

### Community 6 - "task-board-panel.tsx"
Cohesion: 0.06
Nodes (43): renderInlineFormatting(), renderInlineText(), renderSessionContent(), formatTime(), PartRenderer(), ROLE_CONFIG, SessionMessage(), shouldShowTimestamp() (+35 more)
...
### Community 9 - "settings-panel.tsx"
Cohesion: 0.05
...
Cohesion: 0.02
Nodes (148): next, dynamic, GET(), POST(), GET(), GET(), POST(), AlertRule (+140 more)

### Community 11 - "hermes/route.ts"
Cohesion: 0.21
Nodes (14): dataDir, dynamic, extractDeviceAuth(), HOOK_DIR, POST(), countSectionEntries(), getHermesMemory(), HermesMemory (+6 more)
...
Cohesion: 0.02
Nodes (94): reagraph, ConnectorsTab(), Inventory, ActivityTab(), Agent, AgentCronJob, ChannelAccountInfo, ChannelEntryInfo (+86 more)

### Community 14 - "useMissionControl"
Cohesion: 0.03
Nodes (106): bootLabelKeys, CapabilitiesResponse, GatewaySummary, Home(), STEP_KEYS, ChatPanel(), ChatWorkspace(), ChatWorkspaceProps (+98 more)

### Community 15 - "content-router.tsx"
Cohesion: 0.05
Nodes (42): Result, ContentRouter(), ESSENTIAL_PANELS, routedContent(), DashboardPageFrame(), dashboardPageLayout, panelLabel(), usesConversationShell() (+34 more)

### Community 16 - "main.mjs"
Cohesion: 0.11
Nodes (31): openBackend(), partitionForOrigin(), isLoginPage(), ensureServer(), attachWindow(), createWindow(), failedWindows, locked (+23 more)

### Community 17 - "group-sessions.ts"
Cohesion: 0.13
Nodes (18): ChatFilterPopover(), OpenMenu, IconCheck(), toActivityMs(), buildSidebarRows(), ChatProjectItem, ChatSessionItem, DEFAULT_CHAT_FILTERS (+10 more)

### Community 18 - "validation.ts"
Cohesion: 0.03
Nodes (78): POST(), DELETE(), GET(), Pipeline, PipelineStep, POST(), PUT(), EXEC_OPTIONS (+70 more)

### Community 19 - "config"
Cohesion: 0.05
Nodes (63): GET(), POST(), GET(), GET(), POST(), slugify(), GET(), POST() (+55 more)
...
Cohesion: 0.12
Nodes (29): ref_os, BLOCKED_PREFIXES, BLOCKED_VARS, BuiltinCategory, CATEGORIES, checkCommandAvailable(), checkOllamaReachable(), checkOpAuthenticated() (+21 more)
...
Cohesion: 0.12
Nodes (23): fast-check, applyConfig(), computeHash(), gatewayHeaders(), gatewayUrl(), GET(), getConfigPath(), getSchema() (+15 more)

### Community 26 - "ensure-server.mjs"
Cohesion: 0.14
Nodes (16): ensureService(), ensureServices(), healthStatus(), launchctl(), serviceTarget(), startService(), BACKEND, GATEWAY (+8 more)

### Community 27 - "jev-panel.tsx"
Cohesion: 0.12
Nodes (26): JevDraftQuestions(), labels, questions, JevPanel(), QuestionEditorState, VIEW_TITLES, draftFromPolicy(), draftsFromQuestions() (+18 more)

### Community 28 - "chat-desktop-workspace.tsx"
Cohesion: 0.05
Nodes (69): react-dom, react-markdown, remark-gfm, ChatDesktopWorkspace(), IconClose(), SessionArtifactPanel(), SessionPlanPanel(), log (+61 more)

### Community 29 - "helpers.ts"
Cohesion: 0.10
Nodes (5): conv(), API_KEY_HEADER, createTestWorkflow(), deleteTestWorkflow(), dbPath
...
Cohesion: 0.12
Nodes (23): Answer(), humanize(), JevAnswerCards(), nextAction(), JevQuickstart(), JEV_POLICY_TEMPLATES, JevPolicyTemplate, context (+15 more)

### Community 32 - "security-scan.ts"
Cohesion: 0.12
Nodes (24): AgentScanFixRequest, buildSummary(), FixScope, isFixableInScope(), POST(), BackupAutomationState, buildBackupCheck(), Category (+16 more)

### Community 33 - "chat-session-pane.tsx"
Cohesion: 0.12
Nodes (25): ChatSessionRow(), ChatSessionPane(), ContextWindowBar(), transcriptExcerpt(), SessionPrChip(), SessionStatusBar(), SessionThread(), SessionToolRow() (+17 more)
...
Cohesion: 0.13
Nodes (30): ref_node_url, packageFailure(), clearGitCredentials(), withGitAuth(), CHECKS, loadJob(), RUNTIMES, SETUPS (+22 more)

### Community 36 - "chat-model-groups.ts"
Cohesion: 0.16
Nodes (18): ModelPicker(), modelsFor(), SessionHeader(), readJson(), useChatDesktopPrefs(), parsePins(), accessibleEngines(), accessibleModels() (+10 more)
...
Cohesion: 0.07
Nodes (36): JevAssistantConnection(), EXAMPLES, JevAssistantHome(), JevClarificationCard(), JevFlowStep, JevFlowSteps(), STEPS, LABELS (+28 more)

### Community 40 - "db.ts"
Cohesion: 0.04
Nodes (63): GET(), handleActivitiesRequest(), handleStatsRequest(), DELETE(), GET(), PUT(), POST(), GET() (+55 more)

### Community 41 - "chat-composer.tsx"
Cohesion: 0.08
Nodes (32): ChatComposer(), ComposerChips(), PermissionMenu(), UsageBanner(), BAR, UsagePopup(), IconFolder(), IconSend() (+24 more)
...
Cohesion: 0.24
Nodes (16): CAPS, extraNeedle(), liveUsageTracker(), modelNeedle(), oldestSince(), sumTokens(), buildUsageTracker(), clampPercent() (+8 more)
...
Cohesion: 0.04
Nodes (59): UpdateState, ClaudeSetup(), CodexSetup(), HermesSetup(), OpenClawSetup(), OpenCodeSetup(), RuntimeSetupModal(), RuntimeSetupModalProps (+51 more)
...
Cohesion: 0.06
Nodes (47): CachedDoctor, doctorCache, DoctorCacheModule, GET(), getCommandDetail(), invalidateDoctorCache(), isMissingOpenClaw(), POST() (+39 more)

### Community 49 - "activity-timeline-widget.tsx"
Cohesion: 0.53
Nodes (5): LogLike, ActivityTimelineWidget(), getSourceLabel(), getStatusBadge(), timeAgo()

### Community 50 - "package.json"
Cohesion: 0.06
Nodes (33): config, author, description, keywords, license, name, packageManager, version (+25 more)
...
### Community 53 - "fly-reservations.ts"
Cohesion: 0.13
Nodes (23): flyNumber(), flyReadiness(), FlySubmission, flySubmissionSchema, SubmissionRow, submitFlyLeaf(), flyBudgetPeriods(), flyCommittedSpend() (+15 more)
...
Cohesion: 0.05
Nodes (53): POST(), dynamic, POST(), VALID_ROLES, GET(), GET(), GET(), SearchResult (+45 more)

### Community 56 - "memory-utils.ts"
Cohesion: 0.09
Nodes (44): GET(), mergeReports(), POST(), classifyMemoryPath(), extractFrontmatterBlock(), fileStem(), hasDiscoverabilityField(), isHealthScored() (+36 more)
...
Cohesion: 0.13
Nodes (22): CONFUSABLES, decodeRot13(), detectRot13(), escapeHtml(), generateDecodingVariants(), GuardOptions, InjectionCategory, InjectionMatch (+14 more)

### Community 63 - "pty-websocket.ts"
Cohesion: 0.18
Nodes (15): ref_http, http, path, PORT, server, standaloneDir, getPtySession(), handlePtyUpgrade() (+7 more)

### Community 64 - "jev-assistant-api.ts"
Cohesion: 0.13
Nodes (19): check(), ApiProvider, block, boundedJson(), envelope, fail(), generateJevApiDraft(), requestDraft() (+11 more)
...
Cohesion: 0.12
Nodes (25): messages_en, IconSparkle(), ChatUserFooter(), asFeed(), ChatHomeList(), feedTime(), HomeSessionRow, KIND_KEY (+17 more)

### Community 69 - "handoff/route.ts"
Cohesion: 0.05
Nodes (78): dynamic, executeHandoff(), HandoffRequest, makeSpec(), parseBody(), parsedHandoff(), POST(), readReply() (+70 more)
...
Cohesion: 0.05
Nodes (56): GET(), GET(), GET(), GET(), POST(), GET(), mergeContextPayloads(), GET() (+48 more)

### Community 72 - "cost-tracker-panel.tsx"
Cohesion: 0.10
Nodes (29): Dashboard(), CostFleetPlans(), AgentsView(), ByAgentEntry, ByAgentModelBreakdown, ByAgentResponse, COLORS, CostTrackerPanel() (+21 more)
...
Cohesion: 0.13
Nodes (30): src_components_panels_jev_jev_sorter, JevSorterCards(), SorterFilter, answerBucket(), canonical(), DatasetFormat, fingerprintDataset(), humanize() (+22 more)
...
Cohesion: 0.25
Nodes (14): sanitizeForPrompt(), resolveJevAssistantProvider(), generateJevAssistantDraft(), JevAssistantRequest, buildJevAssistantPrompt(), configurationFromRequest(), containsInjection(), createJevAssistantDraft() (+6 more)

### Community 82 - "logAuditEvent"
Cohesion: 0.07
Nodes (80): zod, POST(), GET(), GET(), POST(), POST(), Context, DELETE() (+72 more)
...
### Community 84 - "jev-assistant-provider.ts"
Cohesion: 0.14
Nodes (15): jevAssistantModel(), JEV_ASSISTANT_SYSTEM_PROMPT, checkAvailability(), claudeExecutable(), isJevAssistantAvailable(), PROVIDER_ENV_KEYS, providerEnvironment(), runOnce() (+7 more)
...
Cohesion: 0.16
Nodes (22): ensureTable(), GatewayEntry, getBrowserHostname(), inferBrowserProtocol(), isNonBrowserReachableHost(), LOCALHOST_HOSTS, POST(), resolveRemoteGatewayUrl() (+14 more)

### Community 88 - "permission-mode/route.ts"
Cohesion: 0.18
Nodes (17): dynamic, GET(), PUT(), readOrder(), canSetMode(), dynamic, GET(), PUT() (+9 more)
...
Cohesion: 0.13
Nodes (21): Read this before touching anything, flyFairOrder(), FlyQueuedRow, flyRepositoryDailyCap(), ratio(), repositoryOf(), share(), tally() (+13 more)
...
Cohesion: 0.07
Nodes (29): zustand, Activity, Agent, ChatMessage, Comment, ConnectionStatus, Conversation, CronJob (+21 more)

### Community 94 - "skills/route.ts"
Cohesion: 0.06
Nodes (61): assertRealPathWithin(), auditSkillMutation(), collectSkillsFromDir(), DELETE(), deleteSkill(), dynamic, extractDescription(), GET() (+53 more)
...
Cohesion: 0.24
Nodes (15): buildJevRepositoryContext(), git(), inside(), languageSummary(), projectRoot(), ProjectRow, readBoundedText(), redactContext() (+7 more)
...
Cohesion: 0.08
Nodes (46): GET(), POST(), VALID_MODES, VALID_RUNTIMES, DeploymentMode, detectAllRuntimes(), DETECTORS, detectRuntime() (+38 more)
...
### Community 103 - "claude-sessions.ts"
Cohesion: 0.15
Nodes (14): ref_readline, claudeSessionHomes(), clampTimestamp(), DEFAULT_PRICING, JSONLEntry, lastSyncResult, MAX_SESSION_FILE_BYTES, MODEL_PRICING (+6 more)
...
Cohesion: 0.16
Nodes (18): ref_node_events, cpuTotals(), GET(), getCpuSnapshot(), getDiskSnapshot(), getGpuSnapshot(), getMemorySnapshot(), getNetworkSnapshot() (+10 more)
...
Cohesion: 0.26
Nodes (10): acquireFileLockSync(), dashboardOriginAliases(), getDetectedGatewayPort(), OpenClawGatewayConfig, readOpenClawConfig(), registerMcAsDashboard(), readSecretRefId(), readStoreSecret() (+2 more)
...
### Community 122 - "cron-occurrences.ts"
Cohesion: 0.26
Nodes (11): buildDayKey(), CronOccurrence, getCronOccurrences(), matchesDay(), normalizeCronExpression(), parseCron(), ParsedCron, ParsedField (+3 more)

### Community 123 - "session-terminal-view.tsx"
Cohesion: 0.23
Nodes (7): LINE_CLASS, SessionTerminalView(), TerminalLine, TerminalLineKind, Harness(), TailScroll, useTailScroll()

### Community 124 - "hermes-sessions.ts"
Cohesion: 0.27
...
Cohesion: 0.13
Nodes (23): ref_node_crypto, canonicalJson(), hashJevCloudPayload(), Db, getJevCloudQueueStatus(), JevCloudEvent, jsonFields, prepareJevCloudPayload() (+15 more)

### Community 126 - "security-os-darwin.ts"
Cohesion: 0.21
Nodes (17): CheckStatus, darwinAutoUpdatesCheck(), DarwinCheck, darwinFirewallCheck(), darwinListenPortsCheck(), darwinNtpCheck(), darwinRemoteLoginCheck(), darwinStealthCheck() (+9 more)
...
Cohesion: 0.18
Nodes (14): asNumber(), asObject(), asString(), epochMsToIso(), getOpenCodeDbCandidates(), OpenCodeMessageRow, OpenCodeProjectRow, OpenCodeSessionRow (+6 more)

### Community 129 - "engine-logo.tsx"
Cohesion: 0.05
Nodes (37): Dashboard layout and LLM branding audit, LLM identity system, Overview terminal sessions, Preview verification, EngineLogo(), EngineLogoForText(), LlmLabel(), dismissKey() (+29 more)

### Community 130 - "fly-reconciler.ts"
Cohesion: 0.07
Nodes (35): Rollback, Boundaries, Controller split brain (found during validation, now resolved), Fly worker topology decision — September 6, 2026, Implemented in this change, Measured evidence, Post-redeploy validation (2026-09-06 20:09), Remaining cutover step (not applied) (+27 more)
...
### Community 132 - "chat-fly-jobs.ts"
Cohesion: 0.36
...
Cohesion: 0.06
Nodes (66): allowedFile(), dynamic, GET(), dynamic, GET(), SessionMessageProps, findClaudeTranscriptFile(), keepLastArtifact() (+58 more)

### Community 137 - "mc-mcp-server.cjs"
Cohesion: 0.16
...
### Community 140 - "Production (Docker)"
Cohesion: 0.18
...
### Community 141 - "extractClientIp"
Cohesion: 0.26
Nodes (14): checkOpAvailable(), DELETE(), getEnvPath(), getOpEnv(), handlePull(), handlePullAll(), isVarBlocked(), parseEnv() (+6 more)
...
### Community 143 - "use-folder-dnd.ts"
Cohesion: 0.31
Nodes (10): measure(), playFlip(), prefersReducedMotion(), reorderKeys(), useFolderDnd(), applyFolderOrder(), mergeFolderOrder(), moveFolder() (+2 more)
...
Cohesion: 0.16
Nodes (27): syncAgentsFromConfig(), Result, startFlyReconcileLoop(), Task, syncLocalAgents(), BACKUP_DIR, getEnvNumber(), getNextDailyMs() (+19 more)
...
### Community 150 - "fix/route.ts"
Cohesion: 0.26
Nodes (13): fixRequestSchema, FixResult, getFailingChecks(), getRequestHostCandidates(), normalizeHostname(), parseForwardedHost(), POST(), readEnv() (+5 more)
...
Cohesion: 0.05
Nodes (51): @testing-library/react, FlySessionStatus(), useChatFlyJobs(), EMPTY, useChatUsage(), clearLegacyOrder(), readLegacyOrder(), useFolderOrder() (+43 more)
...
Cohesion: 0.23
Nodes (13): Recovery archive, 2026-09-07, Restoring from the archive, The two entries that are not simply superseded, What the archive holds, GET(), inventoryLooksSafe(), asFleetAgentName(), canonicalFleetAgentName() (+5 more)
...
### Community 174 - "optimize/route.ts"
Cohesion: 0.33
...
### Community 180 - "buildGatewayWebSocketUrl"
Cohesion: 0.44
...
### Community 181 - "workspace-isolation-enforcement.test.ts"
Cohesion: 0.20
...
### Community 183 - "lib/config.ts"
Cohesion: 0.15
Nodes (10): defaultDataDir, defaultMemoryDir, defaultOpenClawStateDir, loadConfigWithEnv(), cachedResult, getHermesCronDir(), HermesCronJob, HermesTaskScanResult (+2 more)
...
### Community 189 - "better-sqlite3"
Cohesion: 0.19
Nodes (8): better-sqlite3, FLEET_AGENT_NAMES, DISCOVERED_PROJECTS, FLEET_PROJECTS, seedFleetProjects(), jevCheckoutBindingMigration, TOKEN_AGENT_KEY_SQL, reassignWorkspaceRows()
...
### Community 191 - "provisioner-client.ts"
Cohesion: 0.33
...
### Community 193 - "workspaces-tenant-access.test.ts"
Cohesion: 0.38
...
Cohesion: 0.21
Nodes (18): SessionTerminalCell(), terminalCellTitle(), transcriptSubject(), workingDirLeaf(), normalizeCliKind(), isAgentWorking(), orderTerminalSessions(), recency() (+10 more)
...
### Community 201 - "mock-gateway.mjs"
Cohesion: 0.33
Nodes (4): ref_node_http, port, server, wss

### Community 202 - "jev-policy-rail.tsx"
Cohesion: 0.38
...
### Community 206 - "github/route.ts"
Cohesion: 0.05
Nodes (79): GET(), handleClose(), handleComment(), handleGitHubStats(), handleInitLabels(), handleStatus(), handleSync(), handleSyncProject() (+71 more)
...
### Community 210 - "local-agent-sync.ts"
Cohesion: 0.21
...
### Community 211 - "fleet-cwd.ts"
Cohesion: 0.52
Nodes (6): fleetProjectSlug(), matchFleetProject(), PATH_ALIASES, specByName(), tildePath(), allSeedProjects()

### Community 212 - "sessions.ts"
Cohesion: 0.15
Nodes (21): dynamic, GET(), partToEvent(), getAllGatewaySessions(), getGatewaySessionStoreFiles(), invalidateSessionCache(), pruneGatewaySessionsOlderThan(), RawSession (+13 more)
...
Cohesion: 0.08
Nodes (60): auditClaudeSessionDispatch(), claudeConfigDirForAgent(), firstExisting(), FleetCliResult, resolveGrokCliPath(), resolveKimiCliPath(), runCli(), runGrokPrompt() (+52 more)
...
Cohesion: 0.08
Nodes (27): @typesafe-ai/sdk, contextModeSchema, enforcementSchema, failureModeSchema, jevPolicyConfigurationSchema, rolloutSchema, scopeSchema, triggerSchema (+19 more)

### Community 225 - "repository"
Cohesion: 0.67
...
### Community 228 - "vault-health.ts"
Cohesion: 0.53
Nodes (5): execDoctor(), execFileAsync, HealthCategory, parseWikiDoctorOutput(), runVaultWikiDoctor()
...
### Community 235 - "detectOpenCode"
Cohesion: 0.67
Nodes (4): detectOpenCode(), getOpenCodeBinaryCandidates(), getOpenCodeVersion(), isOpenCodeInstalled()
...
Cohesion: 0.12
Nodes (17): ref_node_child_process, report, result, detectBinary(), detectClaude(), detectCodex(), FleetProjectSpec, readGhAuthToken() (+9 more)

### Community 243 - "@playwright/test"
Cohesion: 0.07
Nodes (7): @playwright/test, PANELS, PROTECTED_GET_ENDPOINTS, API_KEY_HEADER, API_KEY_HEADER, LIMIT_ENDPOINTS, stamp
...
Cohesion: 0.11
Nodes (24): asRecord(), COLOR_OPTIONS, ConversationList(), renderConversationItem(), ConversationListProps, log, readNumber(), readSessionPrefs() (+16 more)
...
### Community 279 - "jev-assistant-schema.ts"
Cohesion: 0.11
Nodes (14): error(), exceedsJsonDepth(), validateJevAssistantRequest(), clarificationOptionSchema, JEV_ASSISTANT_OUTPUT_JSON_SCHEMA, JevAssistantDraft, jevAssistantDraftSchema, jevAssistantRequestSchema (+6 more)
...
### Community 309 - "workspaces.ts"
Cohesion: 0.14
Nodes (25): DELETE(), GET(), POST(), toProjectId(), DELETE(), GET(), normalizePrefix(), PATCH() (+17 more)

### Community 310 - "Jev sorter workspace"
Cohesion: 0.40
Nodes (4): Data and privacy contract, Deliberate limits, Jev sorter workspace, Verification

### Community 312 - "react"
Cohesion: 0.03
Nodes (82): next-intl, react, ConnectionStatus, GATEWAY_URL_PRESETS, GoogleApi, GoogleCredentialResponse, LoginErrorPayload, LoginPage() (+74 more)
...
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: How is Mission Control set up for client-isolated connectors, shared harnesses, Doppler and Supabase?, Source Nodes
...
## Knowledge Gaps
- **2156 isolated node(s):** `name`, `version`, `private`, `description`, `type` (+2151 more)
...
- `runs.ts` (2× useful, score=1.910604943)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `next` connect `requireRole` to `vitest`, `resolveWithin`, `getDatabase`, `task-board-panel.tsx`, `agent-sync.ts`, `api/memory/route.ts`, `settings-panel.tsx`, `hermes/route.ts`, `agent-squad-panel-phase3.tsx`, `useMissionControl`, `validation.ts`, `config`, `office-panel.tsx`, `integrations/route.ts`, `api/status/route.ts`, `nav-rail.tsx`, `gateway-config/route.ts`, `desktop-browser-login.ts`, `security-scan.ts`, `db.ts`, `proxy.ts`, `doctor/route.ts`, `package.json`, `rate-limit.ts`, `memory-utils.ts`, `exec-approvals/route.ts`, `handoff/route.ts`, `logger.ts`, `mcp-audit.ts`, `gnap-sync.ts`, `onboarding/route.ts`, `logAuditEvent`, `workload/route.ts`, `layout.tsx`, `gateways/connect/route.ts`, `permission-mode/route.ts`, `skills/route.ts`, `fetchWithRetry`, `super-admin.ts`, `memory-search.ts`, `agent-runtimes.ts`, `runCommand`, `recurring-tasks.ts`, `gateways/health/route.ts`, `framework-templates.ts`, `flight-deck/route.ts`, `engine-logo.tsx`, `session-transcript-route.ts`, `pty-manager.ts`, `agent-filesystem-isolation.test.ts`, `tokens/route.ts`, `fix/route.ts`, `[id]/diagnostics/route.ts`, `event-bus.ts`, `message-bubble.tsx`, `api/health/route.ts`, `useSmartPoll`, `keys/route.ts`, `fleet-agents.ts`, `locale-parity.test.ts`, `optimize/route.ts`, `channels/route.ts`, `queue/route.ts`, `chat-folder-order-route.test.ts`, `chat-permission-mode-route.test.ts`, `github/route.ts`, `sessions.ts`, `migrations.ts`, `index/route.ts`, `attribution/route.ts`, `gateways/control/route.ts`, `evals/route.ts`, `conversation-list.tsx`, `jev-assistant-schema.ts`, `tasks-route-noop-update.test.ts`, `workspaces.ts`, `release-update-route-security.test.ts`, `react`, `tasks-bulk-put-agent-access.test.ts`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `vitest` connect `vitest` to `mac-cleanup/index.ts`, `resolveWithin`, `getDatabase`, `chat-icons.tsx`, `task-board-panel.tsx`, `agent-sync.ts`, `api/memory/route.ts`, `settings-panel.tsx`, `requireRole`, `hermes/route.ts`, `agent-squad-panel-phase3.tsx`, `useMissionControl`, `content-router.tsx`, `group-sessions.ts`, `validation.ts`, `config`, `eventBus`, `api/status/route.ts`, `gateway-config/route.ts`, `ensure-server.mjs`, `jev-panel.tsx`, `chat-desktop-workspace.tsx`, `desktop-browser-login.ts`, `jev-ui-types.ts`, `security-scan.ts`, `chat-session-pane.tsx`, `chat-model-groups.ts`, `jev-setup-assistant.tsx`, `db.ts`, `chat-composer.tsx`, `chat-usage-tracker.ts`, `cron-management-panel.tsx`, `apiFetch`, `proxy.ts`, `webhooks.ts`, `doctor/route.ts`, `package.json`, `local-session-list.ts`, `fly-reservations.ts`, `rate-limit.ts`, `memory-utils.ts`, `gateway-config-panel.tsx`, `exec-approvals/route.ts`, `injection-guard.ts`, `jev-assistant-api.ts`, `dashboard-cli-fleets.ts`, `exec-approval-panel.tsx`, `chat-display.ts`, `handoff/route.ts`, `mcp-audit.ts`, `session-terminal-widget.tsx`, `jev-sorter-workspace.tsx`, `gnap-sync.ts`, `onboarding/route.ts`, `session-list-local.ts`, `jev-assistant-service.ts`, `logAuditEvent`, `workload/route.ts`, `jev-assistant-provider.ts`, `layout.tsx`, `gateways/connect/route.ts`, `permission-mode/route.ts`, `dashboard-board.ts`, `fly-workers.ts`, `models.ts`, `skills/route.ts`, `vault-wiki-graph.ts`, `fetchWithRetry`, `jev-context.ts`, `super-admin.ts`, `agent-runtimes.ts`, `claude-sessions.ts`, `websocket-utils.ts`, `runCommand`, `recurring-tasks.ts`, `api-contract-parity.ts`, `cli-inventory.ts`, `device-identity.ts`, `gateway-runtime.ts`, `framework-templates.ts`, `cron-occurrences.ts`, `session-terminal-view.tsx`, `ref_node_crypto`, `security-os-darwin.ts`, `opencode-sessions.ts`, `engine-logo.tsx`, `fly-reconciler.ts`, `chat-fly-jobs.ts`, `claude-code-sessions.ts`, `session-transcript-route.ts`, `session-archive.ts`, `rail-width.ts`, `use-folder-dnd.ts`, `agent-filesystem-isolation.test.ts`, `tokens/route.ts`, `coordinator-routing.ts`, `adapter-compliance.test.ts`, `event-bus.ts`, `message-bubble.tsx`, `api/health/route.ts`, `alert-evaluate.ts`, `useSmartPoll`, `runtime-history.ts`, `kimi-sessions.ts`, `fleet-agents.ts`, `locale-parity.test.ts`, `hook-profiles.ts`, `pty-websocket-auth.test.ts`, `channels/route.ts`, `queue/route.ts`, `ref_node_module`, `buildGatewayWebSocketUrl`, `workspace-isolation-enforcement.test.ts`, `chat-folder-order-route.test.ts`, `lib/config.ts`, `claude-fleet-rename.ts`, `task-dispatch-sandbox.test.ts`, `health-utils.test.ts`, `better-sqlite3`, `openclaw-gateway.ts`, `workspaces-tenant-access.test.ts`, `session-terminal-cell.tsx`, `task-routing.ts`, `chat-permission-mode-route.test.ts`, `jev-policy-rail.tsx`, `typesafe-probe.ts`, `github/route.ts`, `jev-service.ts`, `tcp-port.ts`, `migrations.ts`, `task-dispatch.ts`, `jev-validation.ts`, `token-utils.test.ts`, `gateways/control/route.ts`, `agent-model-trim.test.ts`, `ref_node_child_process`, `vitest.config.ts`, `minimax.ts`, `evals/route.ts`, `jev-assistant-schema.ts`, `fly-stale-controller.ts`, `tasks-route-noop-update.test.ts`, `release-update-route-security.test.ts`, `react`, `tasks-bulk-put-agent-access.test.ts`, `runtime-types.ts`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `engine-logo.tsx`, `widget-grid.tsx`, `widget-primitives.tsx`, `chat-fly-jobs.ts`, `chat-icons.tsx`, `task-board-panel.tsx`, `webhook-panel.tsx`, `settings-panel.tsx`, `rail-width.ts`, `agent-squad-panel-phase3.tsx`, `useMissionControl`, `conversation-list.tsx`, `use-folder-dnd.ts`, `group-sessions.ts`, `content-router.tsx`, `office-panel.tsx`, `nav-rail.tsx`, `jev-panel.tsx`, `chat-desktop-workspace.tsx`, `message-bubble.tsx`, `jev-ui-types.ts`, `chat-session-pane.tsx`, `useSmartPoll`, `chat-model-groups.ts`, `jev-setup-assistant.tsx`, `chat-composer.tsx`, `system-monitor-panel.tsx`, `cron-management-panel.tsx`, `apiFetch`, `package.json`, `websocket.ts`, `gateway-config-panel.tsx`, `dashboard-cli-fleets.ts`, `exec-approval-panel.tsx`, `channels-panel.tsx`, `chat-display.ts`, `session-terminal-cell.tsx`, `agent-comms-panel.tsx`, `cost-tracker-panel.tsx`, `session-terminal-widget.tsx`, `jev-policy-rail.tsx`, `plugins.ts`, `jev-sorter-workspace.tsx`, `layout.tsx`, `session-terminal-view.tsx`, `nodes-panel.tsx`?**
