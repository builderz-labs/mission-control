...
- pipelines/run/route.ts
- openclaw-gateway.ts
- claude-sessions.ts
- github.ts
- check-standalone-artifact.mjs
- deploy-standalone.sh
- terminal-transcript.ts
...
## Communities (335 total, 34 thin omitted)
...
Cohesion: 0.09
Nodes (35): buildDashboardView(), DashboardRequest, REQUEST_LABELS, DashboardGitHubStats, DashboardSystemStats, ActivityIconMini(), AgentIcon(), ClaudeStats (+27 more)
...
### Community 4 - "auth.ts"
Cohesion: 0.06
Nodes (73): ref_crypto, ensureUniqueUsername(), GET(), makeUsernameFromEmail(), POST(), POST(), POST(), POST() (+65 more)

### Community 5 - "chat-icons.tsx"
Cohesion: 0.13
Nodes (17): ComposerChips(), IconArtifacts(), IconClock(), IconClose(), IconCustomize(), IconDispatch(), IconFolder(), IconGrip() (+9 more)

### Community 6 - "task-board-panel.tsx"
Cohesion: 0.07
Nodes (34): 7.A. Про "Owner" и колонку "Awaiting Owner", Agent, AgentsResponse, COLOR_PALETTE, mutate(), Project, ProjectManagerModal(), ProjectsResponse (+26 more)

### Community 7 - "rate-limit.ts"
Cohesion: 0.05
Nodes (44): dynamic, GET(), POST(), POST(), GET(), admitLimiter, dynamic, POST() (+36 more)

### Community 8 - "api/memory/route.ts"
Cohesion: 0.18
Nodes (24): GET(), LinkGraph, mergeGraphs(), scanRoots(), withPathPrefix(), buildFileTree(), DELETE(), GET() (+16 more)

### Community 9 - "content-router.tsx"
Cohesion: 0.03
Nodes (93): bootLabelKeys, CapabilitiesResponse, GatewaySummary, Home(), STEP_KEYS, ContentRouter(), ESSENTIAL_PANELS, routedContent() (+85 more)

### Community 10 - "denyUnscopedResourceForStrictWorkspace"
Cohesion: 0.04
Nodes (87): PUT(), GET(), POST(), BACKUP_DIR, DELETE(), GET(), POST(), pruneOldBackups() (+79 more)
...
Cohesion: 0.06
Nodes (46): ConnectorsTab(), Inventory, ActivityTab(), Agent, AgentCronJob, ChannelAccountInfo, ChannelEntryInfo, ChannelsTab() (+38 more)

### Community 14 - "header-bar.tsx"
Cohesion: 0.06
Nodes (30): getInitialProgress(), ProgressStep, SetupPage(), SetupStep, ModeBadge(), NavigationLatencyStat(), QUICK_NAV_COMMANDS, SearchResult (+22 more)

### Community 15 - "useMissionControl"
Cohesion: 0.06
Nodes (60): ChatInput(), ChatInputProps, ChatPanel(), ChatWorkspace(), ChatWorkspaceProps, ConversationList(), ChatDesktopWorkspace(), MessageBubbleProps (+52 more)

### Community 16 - "main.mjs"
Cohesion: 0.07
Nodes (45): openBackend(), partitionForOrigin(), isLoginPage(), ensureServer(), ensureService(), ensureServices(), healthStatus(), launchctl() (+37 more)

### Community 17 - "group-sessions.ts"
Cohesion: 0.09
Nodes (30): ChatFilterPopover(), OpenMenu, IconChevron(), ChatProjectList(), ChatSidebar(), FolderDragProps, measure(), playFlip() (+22 more)

### Community 18 - "requireRole"
Cohesion: 0.04
Nodes (94): GET(), DELETE(), POST(), GET(), POST(), GET(), PUT(), AlertRule (+86 more)

### Community 19 - "api/tasks/route.ts"
Cohesion: 0.05
Nodes (59): GET(), POST(), GET(), GET(), GET(), POST(), DELETE(), formatTicketRef() (+51 more)
...
Cohesion: 0.12
Nodes (35): BLOCKED_PREFIXES, BLOCKED_VARS, BuiltinCategory, CATEGORIES, checkCommandAvailable(), checkOllamaReachable(), checkOpAuthenticated(), checkOpAvailable() (+27 more)

### Community 23 - "api/status/route.ts"
Cohesion: 0.13
Nodes (26): GET(), getAvailableModels(), getCapabilities(), getDashboardData(), getDbStats(), getGatewayStatus(), getMemorySnapshot(), getSystemStatus() (+18 more)

### Community 24 - "nav-rail.tsx"
Cohesion: 0.04
Nodes (11): adminOnlyPanels, ContextSwitcher(), gatewayOnlyPanels, groupTranslationKeys, MobileBottomSheet(), handleClose(), handleKeyDown(), NavGroup (+3 more)

### Community 25 - "gateway-config/route.ts"
Cohesion: 0.14
Nodes (21): applyConfig(), computeHash(), gatewayHeaders(), gatewayUrl(), GET(), getConfigPath(), getSchema(), PUT() (+13 more)

### Community 26 - "fly-orchestration-panel.tsx"
Cohesion: 0.13
Nodes (20): @testing-library/react, FlyActivityTable(), asRecord(), FlowNode(), FlyOrchestrationPanel(), money(), normalize(), number() (+12 more)
...
Cohesion: 0.16
Nodes (21): cleanTitle(), clipTitle(), ENGINE_LABELS, ENGINE_LOGOS, inferTreeKind(), looksLikeEngineIdTitle(), looksLikeNoisePrompt(), looksLikeSlugTitle() (+13 more)
...
Cohesion: 0.07
Nodes (54): AgentScanFixRequest, buildSummary(), FixScope, isFixableInScope(), POST(), fixRequestSchema, FixResult, getFailingChecks() (+46 more)

### Community 33 - "chat-session-pane.tsx"
Cohesion: 0.13
Nodes (27): ChatSessionPane(), dismissKey(), HandoffBanner(), looksReal(), transcriptExcerpt(), src_components_chat_session_message_sessiontranscriptmessage, SessionPrChip(), SessionThread() (+19 more)

### Community 34 - "task-dispatch.ts"
Cohesion: 0.07
Nodes (48): dispatchToFly(), AgentResponseParsed, buildDeferredCompletionMarkers(), buildReviewPrompt(), buildTaskPrompt(), callCodexViaCli(), clampCliMaxBudgetUsd(), CLAUDE_CLI_ALLOWED_TOOL_NAMES (+40 more)

### Community 35 - "ref_node_assert"
Cohesion: 0.11
Nodes (35): ref_node_assert, ref_node_test, ref_node_url, packageFailure(), clearGitCredentials(), withGitAuth(), CHECKS, loadJob() (+27 more)

### Community 36 - "engine-logo.tsx"
Cohesion: 0.14
Nodes (28): LLM identity system, EngineLogo(), EngineLogoForText(), EngineLogoSet(), LlmLabel(), ChatComposer(), ModelPicker(), UsageBanner() (+20 more)
...
Cohesion: 0.16
Nodes (26): build(), stage(), validCache(), buildOptions(), resolveElectron(), exists(), installApp(), publishCandidate() (+18 more)

### Community 39 - "jev-setup-session-repository.ts"
Cohesion: 0.14
Nodes (26): boundedInteger(), Context, GET(), canManage(), Context, DELETE(), GET(), PATCH() (+18 more)

### Community 40 - "cost-tracker-panel.tsx"
Cohesion: 0.05
Nodes (35): ErrorBoundary, log, Props, State, AgentsView(), ByAgentEntry, ByAgentModelBreakdown, ByAgentResponse (+27 more)

### Community 41 - "permission-connector.ts"
Cohesion: 0.13
Nodes (24): PermissionMenu(), IconCheck(), ALIASES, ARGV, isBypassMode(), isPermissionRuntime(), MODES, parsePermissionMode() (+16 more)

### Community 42 - "next-intl"
Cohesion: 0.14
Nodes (12): messages_en, next-intl, ChatLiveDot(), ChatProjectFolder(), folderProps, row, ChatSessionRow(), GitLensSessionRow (+4 more)
...
Cohesion: 0.02
Nodes (118): react, FlySessionStatus(), ChecklistItem, UpdateState, UpdateState, ClaudeSetup(), CodexSetup(), HermesSetup() (+110 more)
...
Cohesion: 0.10
Nodes (28): ref_node_dns, ref_node_http, ref_node_https, ref_node_stream, port, server, wss, MAX_WEBHOOK_RESPONSE_BYTES (+20 more)

### Community 48 - "next"
Cohesion: 0.04
Nodes (72): next, GET(), VALID_MODES, VALID_RUNTIMES, DELETE(), POST(), dynamic, VALID_ROLES (+64 more)

### Community 49 - "widget-grid.tsx"
Cohesion: 0.09
Nodes (26): SIZE_CLASSES, WIDGET_COMPONENTS, formatBytes(), formatUptime(), HealthRow(), LogLike, StatRow(), ActivityTimelineWidget() (+18 more)

### Community 50 - "package.json"
Cohesion: 0.05
Nodes (35): config, author, description, keywords, license, name, packageManager, version (+27 more)

### Community 51 - "ref_node_crypto"
Cohesion: 0.12
Nodes (27): configure(), readPin(), createPinRecord(), createPinThrottle(), credentialsFromEnvironment(), derive(), parseEnvironment(), unquote() (+19 more)

### Community 52 - "Production (Docker)"
Cohesion: 0.18
...
Cohesion: 0.19
Nodes (23): assertRealPathWithin(), auditSkillMutation(), collectSkillsFromDir(), DELETE(), dynamic, extractDescription(), GET(), getRootBySource() (+15 more)

### Community 54 - "websocket.ts"
Cohesion: 0.07
Nodes (33): HeaderBar(), cacheDeviceToken(), getCachedDeviceToken(), authTokenRef, clearHandshakeTimers(), connectRef, connectSentRef, formatAge() (+25 more)
...
Cohesion: 0.14
Nodes (21): CONFUSABLES, decodeRot13(), detectRot13(), escapeHtml(), generateDecodingVariants(), GuardOptions, InjectionCategory, InjectionMatch (+13 more)
...
Cohesion: 0.11
Nodes (14): Read this before touching anything, Implemented in this change, enabled(), FlyMachineCreateRequest, FlyMachineResponse, FlyMachinesClient, FlyMachinesClientOptions, FlyMachinesError (+6 more)

### Community 65 - "dashboard-cli-fleets.ts"
Cohesion: 0.13
Nodes (24): SessionWorkbenchRow(), SessionWorkbenchWidget(), data(), CLI_KIND_META, CLI_SESSION_KINDS, cliKindLabel(), cliKindMeta, CliSessionKind (+16 more)

### Community 66 - "exec-approval-panel.tsx"
Cohesion: 0.11
Nodes (23): emit(), getSnapshot(), listeners, Snapshot, subscribe(), usePermissionMode(), ExecApprovalOverlay(), formatRemaining() (+15 more)
...
Cohesion: 0.11
Nodes (29): IconSparkle(), ChatUserFooter(), asFeed(), ChatHomeList(), feedTime(), HomeSessionRow, KIND_KEY, pillClass() (+21 more)
...
Cohesion: 0.03
Nodes (88): DELETE(), GET(), POST(), POST(), CachedDoctor, doctorCache, DoctorCacheModule, GET() (+80 more)

### Community 72 - "useSmartPoll"
Cohesion: 0.05
Nodes (53): recharts, useChatFlyJobs(), EMPTY, clearLegacyOrder(), readLegacyOrder(), useFolderOrder(), Activity, activityColors (+45 more)

### Community 73 - "security-events.ts"
Cohesion: 0.08
Nodes (34): GET(), parsePositiveInteger(), GET(), Timeframe, TIMEFRAME_SECONDS, scanAndLogInjection(), getMcpCallStats(), logMcpCall() (+26 more)

### Community 74 - "session-terminal-cell.tsx"
Cohesion: 0.12
Nodes (23): SessionTerminalCell(), terminalCellTitle(), transcriptSubject(), SessionTerminalWidget(), TerminalWidgetData, transcripts, isCliSessionKind(), normalizeCliKind() (+15 more)

### Community 75 - "openclaw-doctor.ts"
Cohesion: 0.20
Nodes (16): detectCategory(), isDoctorTitleLine(), isInformationalDoctorLine(), stripDoctorGutter(), isDecorativeLine(), isPositiveOrInstructionalLine(), isSessionAgingLine(), isStateDirectoryListLine() (+8 more)
...
Cohesion: 0.29
Nodes (9): Dashboard(), CostFleetPlans(), ClaudeFleetAuthStatus, claudeFleetPlanByIntegrationId(), ClaudeFleetPlanDef, ClaudeFleetPlanIdentity, ClaudeFleetPlanStatus, claudeFleetPlanTotalUsd() (+1 more)
...
Cohesion: 0.04
Nodes (77): Frontend components, Answer(), humanize(), JevAnswerCards(), nextAction(), formatTime(), JevHistory(), JevPanel() (+69 more)
...
### Community 81 - "jev-assistant-provider.ts"
Cohesion: 0.11
Nodes (19): ref_node_events, zod, claudeExecutable(), generateJevAssistantDraft(), isJevAssistantAvailable(), JevAssistantProviderError, PROVIDER_ENV_KEYS, providerEnvironment() (+11 more)

### Community 82 - "scheduler.ts"
Cohesion: 0.15
Nodes (28): syncAgentsFromConfig(), syncClaudeSessions(), Result, startFlyReconcileLoop(), Task, syncLocalAgents(), syncRuntimeHistory(), BACKUP_DIR (+20 more)

### Community 83 - "workload/route.ts"
Cohesion: 0.10
Nodes (28): AgentMetrics, buildAgentMetrics(), buildCapacityMetrics(), buildQueueMetrics(), buildThresholds(), CapacityMetrics, computeRecommendation(), escalate() (+20 more)
...
Cohesion: 0.12
Nodes (28): dynamic, PUT(), VALID_SOURCES, VALID_TARGETS, checkSkillSecurity(), fetchAwesomeIndex(), fetchAwesomeOpenclawSkill(), fetchClawdHubSkill() (+20 more)
...
### Community 97 - "jev-assistant-service.ts"
Cohesion: 0.22
...
### Community 99 - "memory-search.ts"
Cohesion: 0.18
Nodes (18): GET(), POST(), rebuildFleetMemoryIndex(), searchFleetMemory(), ensureFtsTable(), ensureIndex(), extractTitle(), indexFile() (+10 more)
...
Cohesion: 0.08
Nodes (40): POST(), DeploymentMode, detectAllRuntimes(), detectOpenClaw(), DETECTORS, detectRuntime(), downloadAndReviewScript(), generateDockerSidecar() (+32 more)
...
Cohesion: 0.16
Nodes (17): cpuTotals(), GET(), getCpuSnapshot(), getDiskSnapshot(), getGpuSnapshot(), getMemorySnapshot(), getNetworkSnapshot(), getProcessSnapshot() (+9 more)
...
### Community 110 - "docs-knowledge.ts"
Cohesion: 0.28
Nodes (15): GET(), allowedRoots(), buildTreeFrom(), DOC_ROOT_CANDIDATES, DocsTreeNode, getDocsTree(), isDocsPathAllowed(), isSearchable() (+7 more)
...
Cohesion: 0.23
Nodes (16): AgentInventory, inventoryForAgent(), inventoryLooksSafe(), runtimeOf(), jsonKeys(), listClaudeMcp(), listCodexAutomations(), listGrokPlugins() (+8 more)
...
### Community 116 - "markdown-renderer.tsx"
Cohesion: 0.31
Nodes (7): react-dom, react-markdown, remark-gfm, getPreviewContent(), MarkdownRenderer(), MarkdownRendererProps, render()
...
### Community 122 - "openclaw-doctor-banner.tsx"
Cohesion: 0.23
...
Cohesion: 0.12
Nodes (25): sleep(), dynamic, GET(), buildFlyActivity(), flySubmissionStatus(), flySubmissionSchema, SubmissionRow, FLY_LAUNCH_BATCH_SIZE (+17 more)

### Community 131 - "session-transcript-types.ts"
Cohesion: 0.13
Nodes (19): renderInlineFormatting(), renderInlineText(), renderSessionContent(), formatTime(), PartRenderer(), ROLE_CONFIG, SessionMessage(), SessionMessageProps (+11 more)

### Community 132 - "claude-transcript.ts"
Cohesion: 0.15
...
### Community 135 - "webhook-panel.tsx"
Cohesion: 0.17
...
Cohesion: 0.13
Nodes (31): dynamic, GET(), VALID_REASONING_LEVELS, VALID_THINKING_LEVELS, VALID_VERBOSE_LEVELS, toSessionItem(), isTreeKind(), projectSlugOf() (+23 more)
...
### Community 140 - "github-pulls-api.ts"
Cohesion: 0.21
...
Cohesion: 0.19
Nodes (14): flyCommittedSpend(), flyFairOrder(), FlyQueuedRow, flyQueueIsContended(), flyRepositoryDailyCap(), flyRepositorySpendToday(), ratio(), repositoryOf() (+6 more)
...
### Community 143 - "assistant/route.ts"
Cohesion: 0.22
...
Cohesion: 0.11
Nodes (31): ref_fs, ref_path, deepMerge(), enrichAgentConfigFromWorkspace(), getConfigPath(), mapAgentToMC(), normalizeAgentConfigForOpenClaw(), normalizeModelConfig() (+23 more)
...
### Community 155 - "agent-avatar.tsx"
Cohesion: 0.24
...
Cohesion: 0.17
Nodes (10): ref_events, dynamic, GET(), runtime, eventBelongsToWorkspace(), EventType, globalBus, ServerEvent (+2 more)

### Community 157 - "message-bubble.tsx"
Cohesion: 0.28
Nodes (10): AGENT_COLORS, asRecord(), formatTime(), getAgentTheme(), MessageBubble(), renderContent(), ToolCallBubble(), detectTextDirection() (+2 more)

### Community 158 - "fly-activity.ts"
Cohesion: 0.32
...
### Community 159 - "websocket-utils.ts"
Cohesion: 0.29
...
### Community 165 - "ref_node_child_process"
Cohesion: 0.10
Nodes (22): ref_node_child_process, report, result, detectBinary(), detectClaude(), detectCodex(), installOpenClawLocal(), inside() (+14 more)

### Community 166 - "fleet-agents.ts"
Cohesion: 0.29
Nodes (10): Recovery archive, 2026-09-07, Restoring from the archive, The two entries that are not simply superseded, What the archive holds, asFleetAgentName(), canonicalFleetAgentName(), FLEET_AGENT_ALIASES, fleetAgentLogo() (+2 more)
...
### Community 168 - "chat/messages/route.ts"
Cohesion: 0.27
...
### Community 171 - "dashboard-widgets.ts"
Cohesion: 0.23
...
Cohesion: 0.29
Nodes (12): acquireFileLockSync(), dashboardOriginAliases(), getDetectedGatewayToken(), OpenClawGatewayConfig, readOpenClawConfig(), registerMcAsDashboard(), cachedGatewayToken(), isUsableGatewayToken() (+4 more)
...
### Community 177 - "integrations-panel.tsx"
Cohesion: 0.17
...
### Community 180 - "models.ts"
Cohesion: 0.29
Nodes (9): classifyModelProvider(), getDispatchModelId(), getModelByAlias(), getModelByName(), ModelCostPerMTok, ModelInputModality, ModelThinkingMode, anthropicDispatchId() (+1 more)

### Community 181 - "artifact/route.ts"
Cohesion: 0.25
Nodes (9): allowedFile(), dynamic, GET(), SessionArtifactPanel(), useSessionArtifact(), SESSION_ID_RE, extractSessionArtifacts(), latestArtifact() (+1 more)

### Community 182 - "readLimiter"
Cohesion: 0.12
Nodes (38): GET(), GET(), POST(), Context, DELETE(), PATCH(), GET(), POST() (+30 more)

### Community 183 - "cron/route.ts"
Cohesion: 0.31
...
### Community 191 - "pipelines/run/route.ts"
Cohesion: 0.31
Nodes (9): advanceRun(), cancelRun(), GET(), PipelineRun, PipelineStep, POST(), RunStepState, spawnStep() (+1 more)

### Community 192 - "openclaw-gateway.ts"
Cohesion: 0.21
...
### Community 193 - "claude-sessions.ts"
Cohesion: 0.16
...
### Community 197 - "terminal-transcript.ts"
Cohesion: 0.17
Nodes (14): LINE_CLASS, SessionTerminalView(), appendPart(), commandArguments(), normalize(), push(), pushClamped(), TerminalLine (+6 more)
...
### Community 202 - "pty-websocket-auth.test.ts"
Cohesion: 0.22
...
Cohesion: 0.13
Nodes (23): POST(), createClient(), evaluateWithJev(), exactKeys(), JevClientError, JevClientOptions, listJevModels(), probabilities() (+15 more)

### Community 209 - "isDirectDispatchAvailable"
Cohesion: 0.42
Nodes (8): firstExisting(), FleetCliResult, resolveGrokCliPath(), resolveKimiCliPath(), runCli(), runGrokPrompt(), runKimiPrompt(), isDirectDispatchAvailable()

### Community 210 - "task-branch-route-agent-access.test.ts"
Cohesion: 0.33
...
### Community 212 - "gateway/route.ts"
Cohesion: 0.20
Nodes (15): dynamic, GET(), partToEvent(), dynamic, GET(), extractAgentName(), GATEWAY_KEY_RE, isSilentReplyText() (+7 more)

### Community 213 - "migrations.ts"
Cohesion: 0.11
Nodes (16): desktopBrowserLoginMigration, flyAdmissionMigration, flyRepairMigration, flyTopologyMigration, jevAssistantMigration, entities, jevCloudMigration, jevEvaluationLifecycleMigration (+8 more)
...
Cohesion: 0.60
Nodes (5): archiveOrphanTranscriptsForStateDir(), collectReferencedTranscriptNames(), formatArchiveTimestamp(), isPrimaryTranscriptFile(), OpenClawDoctorFixResult

### Community 222 - "callDirectly"
Cohesion: 0.12
Nodes (25): claudeConfigDirForAgent(), getMiniMaxApiKey(), MINIMAX_REGIONS, MiniMaxEnvironment, MiniMaxProtocol, MiniMaxRegion, resolveMiniMaxEndpoint(), callClaudeDirectly() (+17 more)
...
Cohesion: 0.09
Nodes (24): fast-check, @typesafe-ai/sdk, contextModeSchema, enforcementSchema, failureModeSchema, jevPolicyConfigurationSchema, rolloutSchema, scopeSchema (+16 more)
...
### Community 228 - "Fly worker topology decision — September 6, 2026"
Cohesion: 0.25
...
### Community 235 - "buildJevRepositoryContext"
Cohesion: 0.50
Nodes (5): buildJevRepositoryContext(), git(), languageSummary(), safePaths(), walkFiles()
...
### Community 239 - "locale-parity.test.ts"
Cohesion: 0.31
...
### Community 257 - "cron-occurrences.ts"
Cohesion: 0.29
...
### Community 265 - "getDatabase"
Cohesion: 0.06
Nodes (54): GET(), handleActivitiesRequest(), handleStatsRequest(), GET(), POST(), GET(), AgentKeyRow, AgentRow (+46 more)
...
### Community 271 - "conversation-list.tsx"
Cohesion: 0.06
Nodes (36): asRecord(), COLOR_OPTIONS, renderConversationItem(), ConversationListProps, log, readNumber(), readSessionPrefs(), readSessions() (+28 more)

### Community 272 - "webhook-retry-lease.ts"
Cohesion: 0.36
Nodes (5): claimDueWebhookRetry(), DueWebhookRetry, releaseWebhookRetryClaim(), WEBHOOK_RETRY_BATCH_LIMIT, WEBHOOK_RETRY_LEASE_SECONDS

### Community 273 - "lib/config.ts"
Cohesion: 0.11
Nodes (18): cachedResult, ClaudeCodeScanResult, ClaudeCodeTask, ClaudeCodeTeam, safeParse(), scanClaudeCodeTasks(), scanTasks(), scanTeams() (+10 more)
...
Cohesion: 0.12
Nodes (14): ConnectionStatus, GATEWAY_URL_PRESETS, GoogleAccountsIdApi, GoogleApi, GoogleCredentialResponse, LoginErrorPayload, LoginPage(), LoginRequestBody (+6 more)
...
### Community 341 - "repository"
Cohesion: 0.67
Nodes (3): repository, type, url

## Knowledge Gaps
- **2122 isolated node(s):** `name`, `version`, `private`, `description`, `type` (+2117 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 2571 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **34 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Work-memory lessons

**Preferred sources** — corroborated by past sessions; start here.
- `runs.ts` (2× useful, score=1.994201285)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `next` connect `next` to `vitest`, `resolveWithin`, `auth.ts`, `task-board-panel.tsx`, `rate-limit.ts`, `api/memory/route.ts`, `content-router.tsx`, `denyUnscopedResourceForStrictWorkspace`, `hermes/route.ts`, `agent-squad-panel-phase3.tsx`, `header-bar.tsx`, `useMissionControl`, `requireRole`, `api/tasks/route.ts`, `office-panel.tsx`, `integrations/route.ts`, `api/status/route.ts`, `nav-rail.tsx`, `gateway-config/route.ts`, `fly-orchestration-panel.tsx`, `desktop-browser-login.ts`, `security-scan.ts`, `engine-logo.tsx`, `jev-setup-session-repository.ts`, `apiFetch`, `proxy.ts`, `package.json`, `skills/route.ts`, `memory-utils.ts`, `exec-approvals/route.ts`, `github/route.ts`, `handoff/route.ts`, `validation.ts`, `security-events.ts`, `gnap-sync.ts`, `workload/route.ts`, `layout.tsx`, `gateways/connect/route.ts`, `onboarding/route.ts`, `skill-registry.ts`, `graph/route.ts`, `fetchWithRetry`, `super-admin.ts`, `memory-search.ts`, `runCommand`, `recurring-tasks.ts`, `gateways/health/route.ts`, `framework-templates.ts`, `flight-deck/route.ts`, `runs.ts`, `fly-reconciler.ts`, `session-transcript-route.ts`, `config`, `github-pulls-api.ts`, `pty-manager.ts`, `assistant/route.ts`, `agent-filesystem-isolation.test.ts`, `tokens/route.ts`, `agent-sync.ts`, `[id]/diagnostics/route.ts`, `agent-avatar.tsx`, `event-bus.ts`, `message-bubble.tsx`, `chat/messages/route.ts`, `api/health/route.ts`, `channels/route.ts`, `artifact/route.ts`, `readLimiter`, `cron/route.ts`, `queue/route.ts`, `pipelines/run/route.ts`, `chat-permission-mode-route.test.ts`, `jev-service.ts`, `task-branch-route-agent-access.test.ts`, `gateway/route.ts`, `migrations.ts`, `index/route.ts`, `attribution/route.ts`, `gateways/control/route.ts`, `locale-parity.test.ts`, `getDatabase`, `conversation-list.tsx`, `tasks-route-noop-update.test.ts`, `login/page.tsx`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `vitest` connect `vitest` to `mac-cleanup/index.ts`, `resolveWithin`, `auth.ts`, `task-board-panel.tsx`, `rate-limit.ts`, `api/memory/route.ts`, `content-router.tsx`, `denyUnscopedResourceForStrictWorkspace`, `hermes/route.ts`, `header-bar.tsx`, `useMissionControl`, `main.mjs`, `group-sessions.ts`, `api/tasks/route.ts`, `api/status/route.ts`, `gateway-config/route.ts`, `fly-orchestration-panel.tsx`, `chat-session-identity.ts`, `desktop-browser-login.ts`, `security-scan.ts`, `chat-session-pane.tsx`, `task-dispatch.ts`, `engine-logo.tsx`, `jev-setup-session-repository.ts`, `permission-connector.ts`, `next-intl`, `chat-usage-tracker.ts`, `cron-management-panel.tsx`, `apiFetch`, `proxy.ts`, `webhooks.ts`, `next`, `package.json`, `skill-sync.ts`, `memory-utils.ts`, `gateway-config-panel.tsx`, `exec-approvals/route.ts`, `injection-guard.ts`, `github/route.ts`, `fly-topology.test.ts`, `dashboard-cli-fleets.ts`, `exec-approval-panel.tsx`, `chat-display.ts`, `handoff/route.ts`, `validation.ts`, `useSmartPoll`, `security-events.ts`, `session-terminal-cell.tsx`, `openclaw-doctor.ts`, `gnap-sync.ts`, `jev-panel.tsx`, `session-list-local.ts`, `jev-assistant-provider.ts`, `github-sync-engine.ts`, `layout.tsx`, `gateways/connect/route.ts`, `onboarding/route.ts`, `dashboard-board.ts`, `skill-registry.ts`, `fetchWithRetry`, `jev-assistant-service.ts`, `super-admin.ts`, `memory-search.ts`, `agent-runtimes.ts`, `runtime-history.ts`, `local-session-list.ts`, `runCommand`, `recurring-tasks.ts`, `api-contract-parity.ts`, `cli-inventory.ts`, `device-identity.ts`, `markdown-renderer.tsx`, `framework-templates.ts`, `openclaw-doctor-banner.tsx`, `jev-cloud.test.ts`, `fly-reconciler.ts`, `session-transcript-types.ts`, `claude-transcript.ts`, `claude-code-sessions.ts`, `ref_node_module`, `config`, `rail-width.ts`, `github-pulls-api.ts`, `fly-reservations.ts`, `assistant/route.ts`, `agent-filesystem-isolation.test.ts`, `tokens/route.ts`, `agent-sync.ts`, `coordinator-routing.ts`, `adapter-compliance.test.ts`, `agent-avatar.tsx`, `event-bus.ts`, `message-bubble.tsx`, `fly-activity.ts`, `websocket-utils.ts`, `alert-evaluate.ts`, `kimi-sessions.ts`, `fleet-agents.ts`, `hook-profiles.ts`, `api/health/route.ts`, `channels/route.ts`, `models.ts`, `artifact/route.ts`, `readLimiter`, `better-sqlite3`, `queue/route.ts`, `health-utils.test.ts`, `fleet-projects.ts`, `openclaw-gateway.ts`, `github.ts`, `terminal-transcript.ts`, `task-routing.ts`, `chat-permission-mode-route.test.ts`, `pty-websocket-auth.test.ts`, `typesafe-probe.ts`, `github-activity.ts`, `jev-service.ts`, `task-branch-route-agent-access.test.ts`, `buildGatewayWebSocketUrl`, `gateway/route.ts`, `migrations.ts`, `callDirectly`, `jev-validation.ts`, `token-utils.test.ts`, `gateways/control/route.ts`, `locale-parity.test.ts`, `openclaw-doctor-route.test.ts`, `cron-occurrences.ts`, `dashboard-page-frame.tsx`, `getDatabase`, `webhook-retry-lease.ts`, `fly-stale-controller.ts`, `tasks-route-noop-update.test.ts`, `agent-model-trim.test.ts`, `workspaces-tenant-access.test.ts`, `login/page.tsx`, `runtime-types.ts`, `vitest.config.ts`, `adapter-assignment-isolation.test.ts`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `getDatabase()` connect `getDatabase` to `fly-reconciler.ts`, `resolveWithin`, `auth.ts`, `claude-code-sessions.ts`, `mac-cleanup/index.ts`, `rate-limit.ts`, `api/memory/route.ts`, `session-transcript-route.ts`, `denyUnscopedResourceForStrictWorkspace`, `config`, `github-pulls-api.ts`, `requireRole`, `api/tasks/route.ts`, `tokens/route.ts`, `adapters/index.ts`, `agent-sync.ts`, `api/status/route.ts`, `local-agent-sync.ts`, `[id]/diagnostics/route.ts`, `desktop-browser-login.ts`, `security-scan.ts`, `task-dispatch.ts`, `ref_node_child_process`, `jev-setup-session-repository.ts`, `chat/messages/route.ts`, `hook-profiles.ts`, `chat-usage-tracker.ts`, `api/health/route.ts`, `next`, `skills/route.ts`, `readLimiter`, `skill-sync.ts`, `queue/route.ts`, `github/route.ts`, `pipelines/run/route.ts`, `claude-sessions.ts`, `github.ts`, `validation.ts`, `security-events.ts`, `session-list-local.ts`, `scheduler.ts`, `workload/route.ts`, `github-sync-engine.ts`, `gateways/connect/route.ts`, `onboarding/route.ts`, `callDirectly`, `attribution/route.ts`, `super-admin.ts`, `memory-search.ts`, `runtime-history.ts`, `local-session-list.ts`, `recurring-tasks.ts`, `gateways/health/route.ts`, `runs.ts`?**
