...
### Community 26 - "fly-admission-schema.ts"
Cohesion: 0.20
...
### Community 42 - "session-handoff.ts"
Cohesion: 0.13
...
### Community 99 - "adaptive-context-handoff.ts"
Cohesion: 0.36
...
### Community 135 - "session-transcript-route.ts"
Cohesion: 0.21
...
### Community 155 - "github-pulls-api.ts"
Cohesion: 0.21
...
### Community 159 - "session-continue-run.ts"
Cohesion: 0.29
...
### Community 185 - "handoff-brief.ts"
Cohesion: 0.38
...
### Community 191 - "assistant/route.ts"
Cohesion: 0.22
...
### Community 201 - "auto-credentials.ts"
Cohesion: 0.36
...
### Community 268 - "ClaudeSdkAdapter"
Cohesion: 0.18
...
### Community 272 - "locale-parity.test.ts"
Cohesion: 0.31
...
### Community 285 - "webhook-retry-lease.ts"
Cohesion: 0.33
...
### Community 332 - "webhook-response.test.ts"
Cohesion: 0.70
...
- `runs.ts` (2× useful, score=1.994365457)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `next` connect `next` to `resolveWithin`, `auth.ts`, `task-board-panel.tsx`, `useMissionControl`, `requireRole`, `hermes/route.ts`, `agent-squad-panel-phase3.tsx`, `login/page.tsx`, `store/index.ts`, `config`, `office-panel.tsx`, `integrations/route.ts`, `api/status/route.ts`, `nav-rail.tsx`, `gateway-config/route.ts`, `getDatabase`, `security-scan.ts`, `engine-logo.tsx`, `jev-setup-session-repository.ts`, `session-handoff.ts`, `apiFetch`, `proxy.ts`, `db.ts`, `package.json`, `skills/route.ts`, `memory-utils.ts`, `exec-approvals/route.ts`, `github/route.ts`, `handoff/route.ts`, `validation.ts`, `react`, `mcp-audit.ts`, `gnap-sync.ts`, `workload/route.ts`, `layout.tsx`, `gateways/connect/route.ts`, `onboarding/route.ts`, `skill-registry.ts`, `graph/route.ts`, `fetchWithRetry`, `super-admin.ts`, `agent-runtimes.ts`, `runCommand`, `recurring-tasks.ts`, `gateways/health/route.ts`, `cli-inventory.ts`, `framework-templates.ts`, `flight-deck/route.ts`, `runs.ts`, `pty/setup/route.ts`, `session-transcript-route.ts`, `agent-filesystem-isolation.test.ts`, `tokens/route.ts`, `agent-sync.ts`, `[id]/diagnostics/route.ts`, `github-pulls-api.ts`, `event-bus.ts`, `message-bubble.tsx`, `api/health/route.ts`, `fix/route.ts`, `channels/route.ts`, `provision-jobs/[id]/route.ts`, `TranscriptMessage`, `jev-repository.ts`, `assistant/route.ts`, `chat-permission-mode-route.test.ts`, `tasks-route-noop-update.test.ts`, `[id]/memory/route.ts`, `aggregate/route.ts`, `migrations.ts`, `index/route.ts`, `attribution/route.ts`, `gateways/control/route.ts`, `permission-mode/route.ts`, `keys/route.ts`, `locale-parity.test.ts`, `release-update-route-security.test.ts`, `tasks-bulk-put-agent-access.test.ts`?**
  _High betweenness centrality (0.199) - this node is a cross-community bridge._
- **Why does `vitest` connect `vitest` to `mac-cleanup/index.ts`, `resolveWithin`, `auth.ts`, `chat-icons.tsx`, `task-board-panel.tsx`, `next`, `useMissionControl`, `requireRole`, `hermes/route.ts`, `agent-squad-panel-phase3.tsx`, `login/page.tsx`, `store/index.ts`, `group-sessions.ts`, `config`, `api/status/route.ts`, `gateway-config/route.ts`, `fly-admission-schema.ts`, `chat-session-identity.ts`, `getDatabase`, `security-scan.ts`, `chat-session-pane.tsx`, `task-dispatch.ts`, `engine-logo.tsx`, `jev-setup-session-repository.ts`, `chat-composer.tsx`, `session-handoff.ts`, `chat-usage-tracker.ts`, `cron-management-panel.tsx`, `apiFetch`, `proxy.ts`, `db.ts`, `package.json`, `Production (Docker)`, `skills/route.ts`, `skill-sync.ts`, `memory-utils.ts`, `gateway-config-panel.tsx`, `exec-approvals/route.ts`, `injection-guard.ts`, `github/route.ts`, `dashboard-cli-fleets.ts`, `exec-approval-panel.tsx`, `chat-display.ts`, `handoff/route.ts`, `validation.ts`, `react`, `mcp-audit.ts`, `session-terminal-widget.tsx`, `openclaw-doctor.ts`, `claude-fleet-plans.ts`, `gnap-sync.ts`, `jev-panel.tsx`, `session-list-local.ts`, `jev-assistant-provider.ts`, `workload/route.ts`, `github-sync-engine.ts`, `layout.tsx`, `gateways/connect/route.ts`, `onboarding/route.ts`, `dashboard-board.ts`, `fly-topology.test.ts`, `skill-registry.ts`, `graph/route.ts`, `fetchWithRetry`, `jev-assistant-service.ts`, `adaptive-context-handoff.ts`, `agent-runtimes.ts`, `runCommand`, `recurring-tasks.ts`, `ref_node_child_process`, `api-contract-parity.ts`, `cli-inventory.ts`, `device-identity.ts`, `markdown-renderer.tsx`, `framework-templates.ts`, `openclaw-doctor-banner.tsx`, `jev-cloud.test.ts`, `pty/setup/route.ts`, `fly-admission.test.ts`, `claude-transcript.ts`, `claude-code-sessions.ts`, `ref_node_module`, `session-archive.ts`, `chat-desktop-workspace.tsx`, `fly-reservations.ts`, `websocket-utils.ts`, `agent-filesystem-isolation.test.ts`, `tokens/route.ts`, `agent-sync.ts`, `coordinator-routing.ts`, `adapter-compliance.test.ts`, `github-pulls-api.ts`, `event-bus.ts`, `message-bubble.tsx`, `chat-fly-jobs.ts`, `session-continue-run.ts`, `alert-evaluate.ts`, `runtime-history.ts`, `kimi-sessions.ts`, `dashboard.tsx`, `fleet-agents.ts`, `dashboard-board-persist.ts`, `hook-profiles.ts`, `task-dispatch-sandbox.test.ts`, `api/health/route.ts`, `fix/route.ts`, `channels/route.ts`, `codex-transcript.ts`, `TranscriptMessage`, `jev-repository.ts`, `session-terminal-cell.tsx`, `better-sqlite3`, `handoff-brief.ts`, `health-utils.test.ts`, `fleet-projects.ts`, `assistant/route.ts`, `openclaw-gateway.ts`, `claude-sessions.ts`, `github.ts`, `ref_node_os`, `task-routing.ts`, `chat-permission-mode-route.test.ts`, `tasks-route-noop-update.test.ts`, `typesafe-probe.ts`, `github-activity.ts`, `jev-service.ts`, `[id]/memory/route.ts`, `session-terminal-view.tsx`, `buildGatewayWebSocketUrl`, `migrations.ts`, `openclaw-doctor-fix.ts`, `minimax.ts`, `jev-validation.ts`, `token-utils.test.ts`, `gateways/control/route.ts`, `permission-mode/route.ts`, `openclaw-doctor-route.test.ts`, `cron-occurrences.ts`, `dashboard-page-frame.tsx`, `locale-parity.test.ts`, `fly-stale-controller.ts`, `release-update-route-security.test.ts`, `webhook-retry-lease.ts`, `tasks-bulk-put-agent-access.test.ts`, `agent-model-trim.test.ts`, `webhooks.test.ts`, `workspaces-tenant-access.test.ts`, `runtime-types.ts`, `webhook-response.test.ts`, `vitest.config.ts`, `adapter-assignment-isolation.test.ts`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `widget-primitives.tsx`, `chat-icons.tsx`, `dashboard-page-frame.tsx`, `task-board-panel.tsx`, `security-audit-panel.tsx`, `useMissionControl`, `chat-desktop-workspace.tsx`, `webhook-panel.tsx`, `agent-squad-panel-phase3.tsx`, `login/page.tsx`, `store/index.ts`, `split-pane-layout.tsx`, `group-sessions.ts`, `office-panel.tsx`, `nav-rail.tsx`, `message-bubble.tsx`, `chat-fly-jobs.ts`, `chat-session-pane.tsx`, `security-scan-card.tsx`, `engine-logo.tsx`, `dashboard.tsx`, `cost-tracker-panel.tsx`, `chat-composer.tsx`, `chat-usage-tracker.ts`, `cron-management-panel.tsx`, `apiFetch`, `widget-grid.tsx`, `package.json`, `TranscriptMessage`, `websocket.ts`, `session-terminal-cell.tsx`, `gateway-config-panel.tsx`, `dashboard-cli-fleets.ts`, `exec-approval-panel.tsx`, `channels-panel.tsx`, `chat-display.ts`, `agent-comms-panel.tsx`, `session-terminal-widget.tsx`, `jev-panel.tsx`, `session-terminal-view.tsx`, `layout.tsx`, `markdown-renderer.tsx`, `memory-browser-panel.tsx`, `plugins.ts`, `openclaw-doctor-banner.tsx`, `skills-panel.tsx`?**
