...
SKILLSET_TOOLS = {
    ...
    "it_ops": MEMORY_TOOLS + SSH_TOOLS + HTTP_TOOLS + OBSIDIAN_TOOLS,
    ...
    "security": MEMORY_TOOLS + SSH_TOOLS + HTTP_TOOLS + GOOGLE_GMAIL_TOOLS + OBSIDIAN_TOOLS,
    "household": MEMORY_TOOLS + HTTP_TOOLS + GOOGLE_CALENDAR_TOOLS + OBSIDIAN_TOOLS,
    "homelab": MEMORY_TOOLS + SSH_TOOLS + HTTP_TOOLS + GOOGLE_DRIVE_TOOLS + OBSIDIAN_TOOLS,
