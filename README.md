...
| `MISSION_CONTROL_DB_PATH` | No | Absolute path to SQLite DB. Avoids data loss when using the standalone server across rebuilds |
| `MISSION_CONTROL_DATA_DIR` | No | Directory for all MC data files. Use an absolute path with standalone server |
