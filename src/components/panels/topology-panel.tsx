    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          <span className={cn("w-4 h-4", data.status === 'online' ? "text-primary" : "text-red-500")}>&equiv;</span>
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2 mb-1">
        <span className="w-4 h-4 text-primary">&mu;</span>
      ...
      <div className="text-[9px] text-muted-foreground uppercase truncate flex items-center justify-between">
        <span>{data.task}</span>
        {data.hasIntervention && <span className="w-3 h-3 text-amber-500">!</span>}
      </div>
    </div>
  )
}
