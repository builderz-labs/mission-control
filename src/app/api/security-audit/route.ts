...
const SECURITY_AUDIT_CACHE_TTL_MS = 30_000
const securityAuditCache = createServerReadCache<any>()
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await securityAuditCache.get(cacheKey, SECURITY_AUDIT_CACHE_TTL_MS, async () => {
